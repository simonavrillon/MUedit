classdef Intandlg < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.EditField_Din.Position = [337 298 28 22];
            ...
            app.EditField_Ain.Position = [373 298 28 22];
            ...
            app.EditField_nchan.Position = [262 322 41 22];
            ...
            app.ChannelsLabel.Position = [257 343 53 22];
            ...
            app.OKButton.Position = [444 320 100 26];
