%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% To remove the duplicates between grids (MUs that share most of their discharge times,
...
function [Pulsenew, distimenew, musclenew] = remduplicatesbgrids(PulseT, distime, muscle, maxlag, jitter, tol, fsamp)
...
while ~isempty(distimmp)
    ...
    musclenew(i) = muscle(duplicates(survivor));
